...
namespace Entitas {
    ...
    public partial class Entity {
        ...
        public Entity AddGameObject(UnityEngine.GameObject newGObject) {
            var component = CreateComponent<GameObjectComponent>(CoreComponentIds.GameObject);
            component.gameObject = newGObject;
            return AddComponent(CoreComponentIds.GameObject, component);
        }

        public Entity ReplaceGameObject(UnityEngine.GameObject newGObject) {
            var component = CreateComponent<GameObjectComponent>(CoreComponentIds.GameObject);
            component.gameObject = newGObject;
